...
(function() {
  ...
  window.tieneAccesoPrivado = false;
  window.activeAudio       = null;
  window.activeCard        = null;
  window.currentPage       = "home";
  window.foroCategoria     = null;
  window.ambientTracks     = [];
  window.ambientIndex      = 0;
  window.ambientAudio      = new Audio();
  window.ambientPlaying    = false;
  window.beatPrivado       = false;
  window.beatsFull         = [];
  window.inspsList         = [];
  window.galeriaTipo       = "foto";
  window.coverBlob         = null;
  window.galeriaBlob       = null;
  window.cropBlob          = null;
  window.currentPerfil     = null;
  window.dmParaId          = null;
  window.dmParaNombre      = "";
  window.onlineChannel     = null;
  window.cropTarget        = null;
  window.cropImg           = null;
  window.cropScale         = 1;
  window.cropX = 0; window.cropY = 0;
  window.cropW = 0; window.cropH = 0;
  window.cropDragging = false;
  window.cropStartX = 0; window.cropStartY = 0;
